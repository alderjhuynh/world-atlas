    ...
    sections: [
      {
        ...
        markdown: `
**[Vosarai](entry.html?c=peoples&id=vosarai)** (the people), **Vosarin** (the language). From *vos-* "shelter, lee" + *-arai* "collective".

The Vosarai live within the confines of [the Northern Wastes](entry.html?c=continents&id=the-northern-wastes), a large and expansive arctic wasteland where nothing grows, and only a few splinter tribes of people live. However, the Vosarai live within a crescent-shaped sheltered area surrounded by vast mountains, blocking out the cold. 
...
The people are usually referred to by their [Common Language](entry.html?c=languages&id=common) exonym **miæɲa ɛlʃamŋa**, meaning "**The Mouth of Flowers**".
        `
      },
      {
        heading: "Phonology",
...
The **Stone** class merges both rock and water, which usually would be unrelated substanced, but to the Vosarai, the cliffs the blocks the arctic cold and the bay that lets traders and ships in are conceptually the same thing: great fixed features that enclose the land.
...
- **-us** (Wilting) rather than a neutral perfective: the exchange isn't just *done*, it's grammatically marked as *concluded and closed* — an emotional undertone of finality (the trade is over, the relationship phase has ended) baked into the verb itself.
...
The object drops its -m marker entirely.
      ...
      },
      {
        ...
        markdown: `
- [The Vosarai, Mouth of Flowers](entry.html?c=peoples&id=vosarai) — The Vosarai are the people who speak Vosarin
- [The Northern Wastes](entry.html?c=continents&id=the-northern-wastes) — Vosarin is spoken within the sheltered crescent of the Northern Wastes
- [The Common Language](entry.html?c=languages&id=common) — The Common Language is the source of the Vosarai's own exonym
        `
      },
    ]
  }
